...
int N,M;
double d=0.15;
double threshold=0.0000000001;//some threshold error is defined, where page rank will converge.
double pr[1000000];
...
int main(){
    double time;
    time = omp_get_wtime();//Returns a value in seconds of the time elapsed from some point.
    cin>>N>>M;
    for(int i=0;i<M;i++)
    {
        int u,v;
